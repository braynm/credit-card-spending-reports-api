defmodule CcSpendingApi.Shared.Result do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> CcSpendingApi.Shared.Result.ok("success")
      {:ok, "success"}

      iex> CcSpendingApi.Shared.Result.error("failed")
      {:error, "failed"}

      iex> {:ok, 5} |> CcSpendingApi.Shared.Result.map(&(&1 * 2))
      {:ok, 10}

      iex> {:error, "fail"} |> CcSpendingApi.Shared.Result.map(&(&1 * 2))
      {:error, "fail"}
  """
  ...
  ## Examples
      ...
      iex> CcSpendingApi.Shared.Result.ok("hello")
      {:ok, "hello"}

      iex> CcSpendingApi.Shared.Result.ok(42)
      {:ok, 42}
  """
  ...
  ## Examples
      ...
      iex> CcSpendingApi.Shared.Result.error("not found")
      {:error, "not found"}

      iex> CcSpendingApi.Shared.Result.error(:invalid_input)
      {:error, :invalid_input}
  """
  ...
  ## Examples
      ...
      iex> {:error, "failed"} |> CcSpendingApi.Shared.Result.map(&(&1 * 2))
      {:error, "failed"}

      iex> {:ok, "hello"} |> CcSpendingApi.Shared.Result.map(&String.upcase/1)
      {:ok, "HELLO"}
  """
  ...
  ## Examples
      ...
      iex> {:ok, 2} |> CcSpendingApi.Shared.Result.bind(divide)
      {:ok, 5.0}

      iex> {:ok, 0} |> CcSpendingApi.Shared.Result.bind(divide)
      {:error, :division_by_zero}

      iex> {:error, "initial error"} |> CcSpendingApi.Shared.Result.bind(divide)
      {:error, "initial error"}
  """
