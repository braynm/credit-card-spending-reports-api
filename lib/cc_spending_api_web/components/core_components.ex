defmodule CcSpendingApiWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CcSpendingApiWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CcSpendingApiWeb.Gettext, "errors", msg, opts)
    end
  end
